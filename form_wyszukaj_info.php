<?php
        ...
        $id=$_GET['id'] ;
        $sql = "SELECT announcement.id,title, park.name, date, description FROM announcement INNER JOIN park ON announcement.park=park.id WHERE  announcement.id like $id";
